...
Setting `client_timeout` explicitly also turns off the automatic sizing of the request budget from `max_tokens` described in [HTTP Client Settings](models-concurrency.qmd#http-client-settings).
