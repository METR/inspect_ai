...
- Checkpointing: New opt-in `restore_usage` option continues a resumed sample's token, cost, turn, time, and working-time usage from its checkpoint instead of restarting at zero.
